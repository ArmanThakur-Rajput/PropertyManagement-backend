...
// Call this whenever user data changes so stale data is not served.
export const clearCachedUser = (id) => {
  userCache.delete(id);
};
...
export const managementPlus = [
  protect,
  requireRole('admin', 'management'),
];

export const leadControlPlus = [
  protect,
  requireRole('admin', 'management'),
];
...
export const staffOnly = [
  protect,
  requireRole('admin', 'management', 'agent'),
];